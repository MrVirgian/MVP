...
echo "\n\e[92mSPAM Send Succes!";
flush();
ob_flush();
sleep(1);
}else {
echo "\n\e[91mSPAM Send Failed!";
flush();
ob_flush();
sleep(1);
}
...
system("clear");
 <font size="5">\e[95MR_VIRGIAN</font><br>
\e[36m===========\e[62m[+++]\n\e[88mAuthor  : Mr.Virgian
Recode  : MrVirgian		
Code    : PHP
Github  : http://github.com/MrVirgian
Team    : SOLO \e[41mPLAYER \e[41m
Version : 2.0 ( Alpha )
\e[36m===========\e[91m>>>>>>>>>>";
echo "\n\e[91mInput Target Number  : ";
